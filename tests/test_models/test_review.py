...
class TestReview_instantiation(unittest.TestCase):
    """Unittests used for testing instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests used for testing save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests used  for testing to_dict method of the Review class."""
