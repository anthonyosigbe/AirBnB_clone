#!/usr/bin/python3
"""Establishes unittests for the 'city.py' module.
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for Certifying the instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unit tests for Examining the save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unit tests for Certifying the to_dict method of the City class."""
