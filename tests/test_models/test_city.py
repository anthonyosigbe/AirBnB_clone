...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for verifying the instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unit tests for assessing the save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unit tests for verifying the to_dict method of the City class."""
