...
class TestState_instantiation(unittest.TestCase):
    """Unittests used for testing instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests used for testing save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests used for testing to_dict method of the State class."""
