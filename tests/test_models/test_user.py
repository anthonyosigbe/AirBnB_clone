#!/usr/bin/python3
"""Establishes unit tests for the 'user.py'
...
class TestUser_save(unittest.TestCase):
    """Unittests for evaluating the save method of the class"""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for examining the to_dict method of the User class."""
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Anthony"
        us.my_number = 98
        self.assertEqual("Anthony", us.middle_name)
